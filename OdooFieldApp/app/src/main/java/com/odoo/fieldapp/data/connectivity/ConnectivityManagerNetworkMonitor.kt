package com.odoo.fieldapp.data.connectivity
 ...
 *
 * Uses NetworkCallback to receive real-time connectivity updates.
 * The flow emits true/false as network state changes.
 */
@Singleton
